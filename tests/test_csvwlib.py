...
async def test_convert():
    foo = await main.return_converted(context='https://github.com/soilwise-he/soil-observation-data-encodings/raw/refs/heads/main/CSVW/examples/example2/leaves-of-tree-metadata-FK.jsonld',
...
@pytest.mark.asyncio
async def test_convert():
    foo = await main.return_converted(context=csvw_sample, output_format="json-ld")
